...
class FavouritesService
{
    ...
    public const PAGES = [
        ...
        'accounting.fixed-assets.dashboard' => ['fixed-assets-centre', 'Fixed Assets Centre', 'briefcase'],
        'accounting.fixed-assets.register' => ['fixed-assets-register', 'Asset Register', 'list'],
        'accounting.fixed-assets.create' => ['fixed-assets-create', 'Acquire Asset', 'plus-circle'],
        'accounting.fixed-assets.categories' => ['fixed-assets-categories', 'Asset Categories', 'tag'],
        'accounting.fixed-assets.depreciation-runs' => ['fixed-assets-dep-runs', 'Depreciation Runs', 'activity'],
        ...
        'accounting.reversals.create' => ['reversal-request', 'Request Reversal', 'undo-2'],
        'accounting.reversals.index' => ['reversals-list', 'Reversal Dashboard', 'list-check'],
        'accounting.reversals.auth' => ['reversal-auth', 'Authorization Dashboard', 'shield-check'],
        'accounting.reversals.rules' => ['reversal-rules', 'Reversal Rules', 'settings'],
        // FA pages rebuilt in Phase 2+
        ...
        'pos.register.index' => ['pos-register', 'POS Register', 'lock'],
        'pos.receipts.index' => ['pos-receipts', 'POS Receipts', 'file-text'],
        'pos.returnables.index' => ['pos-returnables', 'POS Returnables', 'refresh'],
        'pos.products.index' => ['pos-products', 'POS Products', 'package'],
        'pos.settings.index' => ['pos-settings', 'POS Settings', 'settings'],
    ...
    public const RECORD_PAGES = [
        ...
        'accounting.fixed-assets.show' => ['fixed-asset', 'Fixed Asset', 'briefcase'],
