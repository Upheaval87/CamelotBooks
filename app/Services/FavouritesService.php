...
class FavouritesService
{
    ...
    public const PAGES = [
        ...
        'accounting.products.index' => ['products', 'Products', 'box'],
        'accounting.employees.index' => ['employees', 'Employees', 'user'],
        ...
        'accounting.vendor-centre.index' => ['vendor-centre', 'Vendor Centre', 'layout-grid'],
        'accounting.inventory-items.index' => ['inventory-items', 'Inventory Items', 'package'],
        'accounting.item-categories.index' => ['item-categories', 'Item Categories', 'folder'],
        'accounting.assemblies.index' => ['assemblies', 'Assemblies', 'layers'],
        'accounting.stock-adjustments.index' => ['stock-adjustments', 'Stock Adjustments', 'sliders'],
        'accounting.stock-transfers.index' => ['stock-transfers', 'Stock Transfers', 'swap'],
        'accounting.stock-counts.index' => ['stock-counts', 'Stock Counts', 'clipboard-check'],
        'accounting.uom-conversions.index' => ['uom-conversions', 'UOM Conversions', 'ruler'],
        'accounting.landed-costs.index' => ['landed-costs', 'Landed Costs', 'anchor'],
        'accounting.inventory-valuation.index' => ['inventory-valuation', 'Inventory Valuation', 'scale'],
        'accounting.low-stock.index' => ['low-stock', 'Low Stock Report', 'alert-triangle'],
        'accounting.bank-accounts.index' => ['bank-accounts', 'Bank Accounts', 'bank'],
        'accounting.bank-accounts.transfer-form' => ['bank-transfer', 'Transfer Funds', 'arrow-left-right'],
        ...
        'accounting.budgets.index' => ['budgets', 'Budgets', 'target'],
        ...
        'accounting.payroll-runs.index' => ['payroll-runs', 'Payroll Runs', 'banknote'],
        'accounting.paye-tables.index' => ['paye-tables', 'PAYE Tax Tables', 'percent'],
        'accounting.pension-schemes.index' => ['pension-schemes', 'Pension Schemes', 'shield'],
        ...
        'analytics.budget-vs-actual-trend' => ['budget-vs-actual', 'Budget vs Actual', 'target'],
    ...
    public const RECORD_PAGES = [
        ...
        'accounting.item-categories.show' => ['item-category', 'Item Category', 'folder'],
        'accounting.products.show' => ['product', 'Product', 'box'],
        'accounting.inventory-items.show' => ['inventory-item', 'Inventory Item', 'package'],
        'accounting.stock-adjustments.show' => ['stock-adjustment', 'Stock Adjustment', 'sliders'],
        'accounting.stock-transfers.show' => ['stock-transfer', 'Stock Transfer', 'swap'],
        'accounting.assemblies.show' => ['assembly-build', 'Assembly Build', 'layers'],
        'accounting.stock-counts.show' => ['stock-count', 'Stock Count', 'clipboard-check'],
        'accounting.employees.show' => ['employee', 'Employee', 'user'],
        'accounting.payroll-runs.show' => ['payroll-run', 'Payroll Run', 'banknote'],
        'accounting.paye-tables.show' => ['paye-table', 'PAYE Table', 'percent'],
        'accounting.pension-schemes.show' => ['pension-scheme', 'Pension Scheme', 'shield'],
        ...
        'accounting.vendor-centre.show' => ['vendor-centre', 'Vendor Centre', 'layout-grid'],
        ...
        'accounting.budgets.show' => ['budget', 'Budget', 'target'],
