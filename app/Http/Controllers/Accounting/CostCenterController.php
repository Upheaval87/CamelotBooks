...
class CostCenterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accounting.cost-centers.index')->with('success', 'Cost center created successfully.');
    }
    ...
    public function update(Request $request, CostCenter $costCenter)
    {
        ...
        return redirect()->route('accounting.cost-centers.index')->with('success', 'Cost center updated successfully.');
    }
    ...
    public function toggle(CostCenter $costCenter)
    {
        ...
        return redirect()->route('accounting.cost-centers.index')->with('success', "Cost center {$status} successfully.");
    }
}
