...
@php
    $variants = [
        ...
        'accent' => 'border-gold-600/30 bg-gradient-to-b from-[#fffdf6] to-[#f6ecd2] text-gold-700',
        'core' => 'border-gold-600/30 bg-gradient-to-b from-[#fffdf6] to-[#f6ecd2] text-gold-700',
...
@if($variant === 'active')
    <span {{ $attributes->merge(['class' => $base . 'gap-[7px] ' . $variants['active']]) }}>
