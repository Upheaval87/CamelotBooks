<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Sales by Cashier') }}</h2>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($data['cashiers'] as $row)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900">{{ $row['sessions_count'] }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">No cashier sessions found for this period.</td>
                                </tr>
                            @endforelse
                        </tbody>
                        ...
                        <tfoot class="bg-gray-50 font-semibold">
                            <tr>
                                ...
                                <td class="px-6 py-3 text-sm text-right text-gray-900">—</td>
