<x-app-layout>
    <div class="pos">
        <div class="pos-page-head">
            <div>
                <h1>POS Settings</h1>
                <p class="pos-sub">Store · devices · payment methods · preferences</p>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="pos-card" style="margin-bottom:16px">
                    <div class="pos-card-h">
                        ...
                        <div class="pos-right">
                            <a href="{{ route('pos.terminals.index') }}" style="font-size:12px;font-weight:700;color:var(--pos-sec);text-decoration:none">Manage Terminals →</a>
                        </div>
                    </div>
                ...
                <div class="pos-card" style="margin-bottom:16px">
                    <div class="pos-card-h">
                        ...
                        <div class="pos-right">
                            <a href="{{ route('pos.payment-methods.index') }}" style="font-size:12px;font-weight:700;color:var(--pos-sec);text-decoration:none">Manage Methods →</a>
                        </div>
                    </div>
                    <div class="pos-li-wrap">
                        <table class="pos-tbl">
                            ...
                            <tbody>
                                @forelse($paymentMethods as $pm)
                                    <tr>
                                        ...
                                        <td><span class="pos-tchip pos-tchip-pay">{{ ucwords(str_replace('_', ' ', $pm->type)) }}</span></td>
                                        <td class="pos-em">{{ $pm->clearingAccount?->name ?? '—' }}</td>
                                        <td class="num">{{ $pm->requires_reference ? 'Yes' : 'No' }}</td>
                                        <td>
                                            @if($pm->is_active)
                                                <span class="pos-badge pos-badge-open"><span class="pos-bdot"></span>Active</span>
                                            @else
