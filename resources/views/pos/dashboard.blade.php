            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="{{ route('pos.sales.checkout') }}"
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-gold-soft rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-gold-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
