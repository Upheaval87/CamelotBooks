                            ...
                            <tr class="transition-colors hover:bg-[rgba(17,69,75,.035)]">
                                <td class="px-5 py-[18px] align-middle">
                                    ...
                                    @if($module->description)
                                        <span class="mt-0.5 block max-w-[420px] text-[0.893rem] leading-relaxed text-gray-400">{{ $module->description }}</span>
                                    @endif
                                </td>
                                <td class="px-5 py-[18px] align-middle">
                                    @if($module->is_core)
                                ...
                                <td class="px-5 py-[18px] text-center align-middle">
                                    @if($module->is_core)
                                        <span class="inline-flex items-center gap-1.5 rounded-[10px] border border-slate-200 bg-slate-100/70 px-3 py-2 text-[0.893rem] font-semibold text-slate-500">
