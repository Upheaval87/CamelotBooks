<x-app-layout>
    <x-list-header title="{{ __('Add Numbering Sequence') }}" />
                    ...
                    <form method="POST" action="{{ route('admin.numbering-sequences.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} class="rounded border-gray-300 text-gold-700 shadow-sm focus:ring-gold-500">
