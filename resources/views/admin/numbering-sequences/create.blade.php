    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
        <div class="form-page">
            ...
            <x-form.quick-actions :title="__('Quick Actions')" :groups="[
                ['label' => __('View'), 'links' => [
                    ['title' => __('Back to List'), 'route' => route('admin.numbering-sequences.index'), 'icon' => '<svg class=\"w-4 h-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" stroke-width=\"1.5\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M10 19l-7-7m0 0l7-7m-7 7h18\"/></svg>'],
                ]],
            ]" />
        </div>
    </div>
