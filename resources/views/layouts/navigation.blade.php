<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-6 sm:flex">
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        ...
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-56 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                            ...
                            <div class="border-t border-gray-100 my-1"></div>
                            <a href="{{ route('accounting.inventory.dashboard') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100 font-medium">{{ __('Inventory Centre') }}</a>
                        </div>
                    </div>

                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ str_starts_with($routeName, 'accounting.inventory.') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Inventory') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-52 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity5">
                            <a href="{{ route('accounting.inventory.dashboard') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Dashboard') }}</a>
                            <a href="{{ route('accounting.inventory.items') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Items') }}</a>
                            <a href="{{ route('accounting.invsetup.categories') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Categories') }}</a>
                            <a href="{{ route('accounting.invsetup.assemblies') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Assemblies') }}</a>
                            <a href="{{ route('accounting.invsetup.transfers') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Transfers') }}</a>
                            <a href="{{ route('accounting.invsetup.adjustments') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Adjustments') }}</a>
                            <a href="{{ route('accounting.invsetup.stockcount') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Stock Count') }}</a>
                            <a href="{{ route('accounting.invsetup.valuation') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Valuation') }}</a>
                            <a href="{{ route('accounting.invsetup.lowstock') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Low Stock') }}</a>
                        </div>
                    </div>

                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('accounting.bank-accounts.*') || request()->routeIs('accounting.bank-reconciliation.*') || request()->routeIs('accounting.deposits.*') || request()->routeIs('accounting.cheques.*') || request()->routeIs('accounting.petty-cash.*') || request()->routeIs('accounting.cash-position.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Banking') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        ...
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-52 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                            ...
                            <a href="{{ route('accounting.rj.dashboard') }}" class="block px-4 py-1.5 text-sm text-gray-700 hover:bg-gray-100">{{ __('Recurring Journals') }}</a>
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('accounting.income-statement.*') || request()->routeIs('accounting.balance-sheet.*') || request()->routeIs('accounting.cash-flow.*') || request()->routeIs('accounting.aging.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Reports') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-52 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                            <a href="{{ route('accounting.report-center.index') }}" class="block px-4 py-1.5 text-sm font-semibold text-gold-700 hover:bg-gray-100">{{ __('Report Center') }}</a>
                            <div class="border-t border-gray-100 my-1"></div>
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('analytics.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Analytics') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-52 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('bi.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('BI') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-56 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('pos.*') || request()->routeIs('pos.eis.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('POS') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute z-50 mt-1 w-52 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('system-settings.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Settings') }}
                        </button>
                    ...
                    <div class="relative" x-data="{ ddOpen: false }" @click.away="ddOpen = false">
                        <button @click="ddOpen = !ddOpen" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition {{ request()->routeIs('admin.*') ? 'border-gold-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            {{ __('Admin') }}
                            <svg class="ms-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="ddOpen" x-transition x-cloak class="absolute right-0 z-50 mt-1 w-56 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                ...
                <div class="relative" x-data="{ companyOpen: false }" @click.away="companyOpen = false">
                    ...
                    <div x-show="companyOpen" x-transition x-cloak class="absolute right-0 z-50 mt-1 w-56 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                        ...
                        <a href="{{ route('companies.select', $uc->id) }}"
                           class="block px-4 py-2 text-sm {{ $uc->id === session('current_company_id') ? 'bg-gold-soft text-gray-900 font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
                            {{ $uc->name }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('accounting.inventory.dashboard')" :active="request()->routeIs('accounting.inventory.dashboard')">{{ __('Dashboard') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('accounting.inventory.items')" :active="str_starts_with(request()->route()?->getName() ?? '', 'accounting.inventory.items')">{{ __('Items') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('accounting.invsetup.categories')" :active="str_starts_with(request()->route()?->getName() ?? '', 'accounting.invsetup.categories')">{{ __('Categories') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('accounting.invsetup.stockcount')" :active="str_starts_with(request()->route()?->getName() ?? '', 'accounting.invsetup.stockcount')">{{ __('Stock Count') }}</x-responsive-nav-link>
