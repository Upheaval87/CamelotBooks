<x-app-layout>
    ...
    <x-slot name="header">{{ __('Edit Employee') }}: {{ $employee->full_name }}</x-slot>
                    ...
                    <div class="card p-6">
                        <form method="POST" action="{{ route('accounting.employees.update', $employee) }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="employee_number" name="employee_number" type="text" class="mt-1 block w-full" :value="old('employee_number', $employee->employee_number)" required autofocus />
                            ...
                            <div class="grid grid-cols-3 gap-6 mt-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="middle_name" name="middle_name" type="text" class="mt-1 block w-full" :value="old('middle_name', $employee->middle_name)" />
                            ...
                            <div class="mt-6">
                                ...
                                <textarea id="address" name="address" rows="3" class="input mt-1">{{ old('address', $employee->address) }}</textarea>
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :label="old('branch_id', $employee->branch_id) ? ($branches->firstWhere('id', (int) old('branch_id', $employee->branch_id))?->name ?? '') : ''"
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :value="old('cost_center_id', $employee->cost_center_id)"
                                        :label="old('cost_center_id', $employee->cost_center_id) ? ($costCenters->firstWhere('id', (int) old('cost_center_id', $employee->cost_center_id))?->name ?? '') : ''"
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <x-text-input id="tax_id" name="tax_id" type="text" class="mt-1 block w-full" :value="old('tax_id', $employee->tax_id)" />
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <x-text-input id="pension_member_number" name="pension_member_number" type="text" class="mt-1 block w-full" :value="old('pension_member_number', $employee->pension_member_number)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="pension_scheme_id" name="pension_scheme_id" type="text" class="mt-1 block w-full" :value="old('pension_scheme_id', $employee->pension_scheme_id)" />
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <x-text-input id="bank_account_name" name="bank_account_name" type="text" class="mt-1 block w-full" :value="old('bank_account_name', $employee->bank_account_name)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="bank_branch_code" name="bank_branch_code" type="text" class="mt-1 block w-full" :value="old('bank_branch_code', $employee->bank_branch_code)" />
                            ...
                            <div class="mt-6">
                                ...
                                <x-text-input id="basic_pay" name="basic_pay" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('basic_pay', $employee->currentSalaryStructure?->basic_pay)" />
                            ...
                            <div class="mt-6">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Enter a new password to change it, or leave blank to keep current.</p>
