<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('accounting.employees.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                {{ __('Create Employee') }}
            </a>
        </div>
    </x-slot>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($employees as $employee)
                                <tr class="{{ $employee->is_active ? '' : 'bg-gray-50 text-gray-400' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <a href="{{ route('accounting.employees.show', $employee) }}" class="text-indigo-600 hover:text-indigo-900">
                                            {{ $employee->full_name }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        ...
                                        <a href="{{ route('accounting.employees.edit', $employee) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
