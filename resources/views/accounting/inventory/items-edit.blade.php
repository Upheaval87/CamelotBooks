<x-app-layout>
    <div class="inv-wrap py-6">
        ...
        <form method="POST" action="{{ route('accounting.inventory.items.update', $product) }}" class="inv-form" style="max-width:900px">
            @csrf @method('PUT')
            <div class="inv-card">
                <div class="inv-sec-lead">
                    <div class="inv-sec-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/></svg></div>
                    <div class="inv-sec-title">{{ __('Item Details') }}</div>
                </div>
            ...
            <div class="inv-card">
                <div class="inv-sec-lead">
                    <div class="inv-sec-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg></div>
                    <div class="inv-sec-title">{{ __('Pricing & GL') }}</div>
                </div>
                <div class="inv-form-row-3">
                    <div class="inv-form-group">
