<x-app-layout>
    <x-list-header title="{{ __('Edit Asset Category') }}: {{ $category->code }} - {{ $category->name }}" />
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="is_revaluation_enabled" name="is_revaluation_enabled" value="1" {{ old('is_revaluation_enabled', $category->is_revaluation_enabled) ? 'checked' : '' }} class="rounded border-gray-300 text-gold-700 focus:ring-gold-500" />
