<x-app-layout>
    <x-list-header title="{{ __('Create Asset Category') }}" />
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="is_revaluation_enabled" name="is_revaluation_enabled" value="1" {{ old('is_revaluation_enabled') ? 'checked' : '' }} class="rounded border-gray-300 text-gold-700 focus:ring-gold-500" />
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :value="old('asset_account_id')"
                                        :label="old('asset_account_id') ? (($accounts->firstWhere('id', (int) old('asset_account_id'))) ? $accounts->firstWhere('id', (int) old('asset_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('asset_account_id'))->name : '') : ''"
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('accumulated_depreciation_account_id')"
                                        :label="old('accumulated_depreciation_account_id') ? (($accounts->firstWhere('id', (int) old('accumulated_depreciation_account_id'))) ? $accounts->firstWhere('id', (int) old('accumulated_depreciation_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('accumulated_depreciation_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('depreciation_expense_account_id')"
                                        :label="old('depreciation_expense_account_id') ? (($accounts->firstWhere('id', (int) old('depreciation_expense_account_id'))) ? $accounts->firstWhere('id', (int) old('depreciation_expense_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('depreciation_expense_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('accumulated_impairment_account_id')"
                                        :label="old('accumulated_impairment_account_id') ? (($accounts->firstWhere('id', (int) old('accumulated_impairment_account_id'))) ? $accounts->firstWhere('id', (int) old('accumulated_impairment_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('accumulated_impairment_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('impairment_loss_account_id')"
                                        :label="old('impairment_loss_account_id') ? (($accounts->firstWhere('id', (int) old('impairment_loss_account_id'))) ? $accounts->firstWhere('id', (int) old('impairment_loss_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('impairment_loss_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('disposal_gain_loss_account_id')"
                                        :label="old('disposal_gain_loss_account_id') ? (($accounts->firstWhere('id', (int) old('disposal_gain_loss_account_id'))) ? $accounts->firstWhere('id', (int) old('disposal_gain_loss_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('disposal_gain_loss_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        entity="account"
                                        search-url="{{ route('accounting.search.entity', ['entity' => 'account']) }}"
                                        :value="old('revaluation_surplus_account_id')"
                                        :label="old('revaluation_surplus_account_id') ? (($accounts->firstWhere('id', (int) old('revaluation_surplus_account_id'))) ? $accounts->firstWhere('id', (int) old('revaluation_surplus_account_id'))->code . ' - ' . $accounts->firstWhere('id', (int) old('revaluation_surplus_account_id'))->name : '') : ''"
                                        placeholder="{{ __('Select Account') }}"
                                    />
