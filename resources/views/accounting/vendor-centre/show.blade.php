            ...
            <div class="detail-page">
                                    ...
                                    <tbody>
                                        @foreach($timeline as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item['date'] instanceof \Carbon\Carbon ? $item['date']->format('M d, Y') : $item['date'] }}</td>
                ...
                <x-detail-quick-actions :groups="[
                    ['label' => __('Insights'), 'links' => [
                        ['route' => route('accounting.vendor-centre.print', $vendor), 'icon' => 'print', 'title' => __('Print')],
                    ]],
                    ['label' => __('Navigation'), 'links' => [
                        ['route' => route('accounting.vendors.index'), 'icon' => 'back', 'title' => __('Back')],
                    ]],
                ]" />
            </div>
        </div>
