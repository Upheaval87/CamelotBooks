            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ number_format($customer->credit_limit ?? 0, 2) }}</dd>
                    </div>
                    <div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ number_format($customer->opening_balance ?? 0, 2) }}</dd>
                    </div>
                    <div>
