                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Balance ({{ $cs }})</th>
                            ...
                            @forelse($vendors as $vendor)
                                <tr class="{{ $vendor->is_active ? '' : 'bg-gray-50 text-gray-400' }}">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <a href="{{ route('accounting.vendors.show', $vendor) }}" class="text-indigo-600 hover:text-indigo-900">
                                            {{ $vendor->name }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        <a href="{{ route('accounting.vendors.edit', $vendor) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
