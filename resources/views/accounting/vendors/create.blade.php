                ...
                <form method="POST" action="{{ route('accounting.vendors.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="remit_to_address" name="remit_to_address" rows="2" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('remit_to_address') }}</textarea>
