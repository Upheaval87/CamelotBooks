<x-app-layout>
    ...
    <x-list-header title="{{ __('Edit Product') }}: {{ $product->name }}" />
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :value="old('income_account_id', $product->income_account_id)"
                                        :label="old('income_account_id', $product->income_account_id) ? (($incomeAccounts->firstWhere('id', (int) old('income_account_id', $product->income_account_id))) ? $incomeAccounts->firstWhere('id', (int) old('income_account_id', $product->income_account_id))->code . ' - ' . $incomeAccounts->firstWhere('id', (int) old('income_account_id', $product->income_account_id))->name : '') : ''"
                                        placeholder="{{ __('None') }}"
                                    />
                            ...
                            <div class="grid grid-cols-2 gap-6 mt-6">
                                ...
                                <div class="flex items-end pb-1">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_taxable" value="1" {{ old('is_taxable', $product->is_taxable) ? 'checked' : '' }} class="rounded border-gray-300 text-gold-700 focus:ring-gold-500" />
