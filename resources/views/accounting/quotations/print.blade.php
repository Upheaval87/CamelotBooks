...
<head>
    ...
    <style>
        @page {
            ...
            margin: 0 0 12mm 0;
            @bottom-right {
                content: "{{ __('Quotation') }} · PAGE " counter(page) " OF " counter(pages);
...
<body onload="window.print()">
    <div class="canvas">
        ...
        <div class="p-meta">
            <div class="mi"><span class="l">{{ __('Date') }}</span><span class="v">{{ $quotation->quotation_date?->format('M d, Y') ?? '—' }}</span></div>
            <div class="mi"><span class="l">{{ __('Valid Until') }}</span><span class="v">{{ $quotation->valid_until?->format('M d, Y') ?? '—' }}</span></div>
            <div class="mi"><span class="l">{{ __('Reference') }}</span><span class="v">{{ $quotation->reference ?? '—' }}</span></div>
        ...
        @include('components.pdf.chrome', [
            ...
            'pageLabel' => __('Quotation') . ' · ' . __('Page 1 of 1'),
        ])
