...
<x-app-layout>
    <div class="wz max-w-8xl mx-auto sm:px-6 lg:px-8 py-6" x-data="payrollOnboard()" x-cloak>
        ...
        <div style="margin-bottom:4px">
            <h1 style="font-size:22px;font-weight:800;color:var(--ink);margin:0">{{ __('Onboard a new employee') }}</h1>
            <div style="font-size:13px;color:var(--muted);margin-top:4px">{{ __('Six short steps with smart defaults.') }}</div>
        </div>

        {{-- Stepper (reactive via :class) --}}
        <div id="wz-stepper">
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('accounting.payroll.employees.store') }}" id="onboard-form" class="wz-formcard" enctype="multipart/form-data">
            @csrf
                ...
                <div class="wz-bd">
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="text" name="first_name" class="wz-in" required value="{{ old('first_name') }}" x-model="fd.first_name">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Last Name') }} <span class="wz-req">*</span></label>
                            <input type="text" name="last_name" class="wz-in" required value="{{ old('last_name') }}" x-model="fd.last_name">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Middle Name') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="middle_name" class="wz-in" value="{{ old('middle_name') }}" x-model="fd.middle_name">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Email') }} <span class="wz-req">*</span></label>
                            <input type="email" name="email" class="wz-in" required value="{{ old('email') }}" x-model="fd.email">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Phone') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="phone" class="wz-in" value="{{ old('phone') }}" x-model="fd.phone">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Date of Birth') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="date" name="date_of_birth" class="wz-in" value="{{ old('date_of_birth') }}" x-model="fd.date_of_birth">
                        </div>
                        <div class="wz-field">
                        ...
                        <div class="wz-field">
                            ...
                            <input type="text" name="national_id" class="wz-in" required value="{{ old('national_id') }}" x-model="fd.national_id">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Tax ID') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="tax_id" class="wz-in" value="{{ old('tax_id') }}" x-model="fd.tax_id">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Nationality') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="nationality" class="wz-in" value="{{ old('nationality', 'Malawi') }}" x-model="fd.nationality">
                        </div>
                        <div class="wz-field">
                        ...
                        <div class="wz-field">
                            ...
                            <input type="number" name="dependents" class="wz-in" min="0" value="{{ old('dependents') }}" x-model="fd.dependents">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Place of Residence') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="place_of_residence" class="wz-in" value="{{ old('place_of_residence') }}" x-model="fd.place_of_residence">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Home Village') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="home_village" class="wz-in" value="{{ old('home_village') }}" x-model="fd.home_village">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Home District') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="home_district" class="wz-in" value="{{ old('home_district') }}" x-model="fd.home_district">
                        </div>
                    </div>
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="text" name="nok_name" class="wz-in" value="{{ old('nok_name') }}" x-model="fd.nok_name">
                        </div>
                        <div class="wz-field">
                            ...
                            <select name="nok_relationship" class="wz-in" x-model="fd.nok_relationship">
                                <option value="">{{ __('Select...') }}</option>
                                <option value="spouse" {{ old('nok_relationship') === 'spouse' ? 'selected' : '' }}>{{ __('Spouse') }}</option>
                                <option value="parent" {{ old('nok_relationship') === 'parent' ? 'selected' : '' }}>{{ __('Parent') }}</option>
                                <option value="child" {{ old('nok_relationship') === 'child' ? 'selected' : '' }}>{{ __('Child') }}</option>
                                <option value="sibling" {{ old('nok_relationship') === 'sibling' ? 'selected' : '' }}>{{ __('Sibling') }}</option>
                                <option value="other" {{ old('nok_relationship') === 'other' ? 'selected' : '' }}>{{ __('Other') }}</option>
                            </select>
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Phone') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="text" name="nok_phone" class="wz-in" value="{{ old('nok_phone') }}" x-model="fd.nok_phone">
                        </div>
                    </div>
                    ...
                    <div class="wz-section-head" style="margin-top:24px">
                        ...
                        {{ __('Documents') }} <span class="wz-opt" style="margin-left:6px">{{ __('optional') }}</span>
                    </div>
                    <div class="wz-docs-grid">
                        {{-- Passport Photo --}}
                        <div class="wz-doc-tile">
                            ...
                            <div class="wz-doc-label">{{ __('Passport Photo') }}</div>
                        ...
                        <div class="wz-doc-tile">
                            ...
                            <div class="wz-doc-label">{{ __('National ID') }}</div>
                        ...
                        <div class="wz-doc-tile wz-doc-custom">
                            ...
                            <input type="file" name="document_custom_1" class="wz-hidden-input" @change="previewFile($event, 'custom1')">
                            <label class="wz-doc-btn">
                ...
                <div class="wz-bd">
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="text" name="position" class="wz-in" required value="{{ old('position') }}" x-model="fd.position">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Department') }} <span class="wz-req">*</span></label>
                            <input type="text" name="department" class="wz-in" required value="{{ old('department') }}" x-model="fd.department">
                        </div>
                        <div class="wz-field">
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="date" name="hire_date" class="wz-in" required value="{{ old('hire_date', date('Y-m-d')) }}" x-model="fd.hire_date">
                        </div>
                        <div class="wz-field">
                            ...
                            <select name="employment_type" class="wz-in" x-model="fd.employment_type">
                                ...
                                <option value="casual" {{ old('employment_type') === 'casual' ? 'selected' : '' }}>{{ __('Casual') }}</option>
                                <option value="temporary" {{ old('employment_type') === 'temporary' ? 'selected' : '' }}>{{ __('Temporary') }}</option>
                            </select>
                        </div>
                        <div class="wz-field" x-show="needsEndDate" x-transition>
                            <label>{{ __('End Date') }} <span class="wz-req">*</span></label>
                            <input type="date" name="employment_end_date" class="wz-in" :required="needsEndDate" value="{{ old('employment_end_date') }}" x-model="fd.employment_end_date">
                            <div class="wz-hint">{{ __('Required for non-Full-Time employment.') }}</div>
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Employment Status') }} <span class="wz-req">*</span></label>
                ...
                <div class="wz-bd">
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="number" name="basic_salary" class="wz-in" required min="0" step="0.01" value="{{ old('basic_salary') }}" x-model.number="fd.basic_salary">
                        </div>
                        <div class="wz-field">
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="number" name="housing_allowance" class="wz-in" min="0" step="0.01" value="{{ old('housing_allowance') }}" x-model.number="fd.housing_allowance">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Transport') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="number" name="transport_allowance" class="wz-in" min="0" step="0.01" value="{{ old('transport_allowance') }}" x-model.number="fd.transport_allowance">
                        </div>
                        <div class="wz-field">
                            <label>{{ __('Other') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                            <input type="number" name="other_allowances" class="wz-in" min="0" step="0.01" value="{{ old('other_allowances') }}" x-model.number="fd.other_allowances">
                        </div>
                    </div>
                            ...
                            <div class="wz-allow-grid">
                                @foreach($allowances as $allowance)
                                    <div class="wz-allow-item">
                                        <input type="checkbox" name="allowances[{{ $loop->index }}][allowance_id]" value="{{ $allowance->id }}" id="allow_{{ $allowance->id }}" style="width:auto;height:auto;border-radius:4px;padding:0">
                                        ...
                                        <input type="number" name="allowances[{{ $loop->index }}][amount]" class="wz-in" style="width:100px;height:36px;border-radius:8px" min="0" step="0.01" placeholder="0.00" value="{{ old("allowances.{$loop->index}.amount") }}">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="wz-bd">
                    ...
                    <div class="wz-grid">
                        ...
                        <div class="wz-field">
                            ...
                            <input type="text" name="pension_member_number" class="wz-in" value="{{ old('pension_member_number') }}" x-model="fd.pension_member_number">
                        </div>
                        <div class="wz-field">
            ...
            <div class="wzpanel" :class="{ 'wz-on': step === 5 }" x-show="step === 5" x-transition>
                ...
                <div class="wz-bd">
                    ...
                    <div x-show="fd.payment_method === 'bank_transfer'" x-transition>
                        <div class="wz-section-head" style="margin-top:24px">
                            <span class="wz-sec-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M3 10h18"/><path d="M5 6l7-3 7 3"/><path d="M4 10v11"/><path d="M20 10v11"/><path d="M8 10v11"/><path d="M12 10v11"/><path d="M16 10v11"/></svg>
                            </span>
                            {{ __('Bank Details') }}
                        </div>
                        <div class="wz-grid">
                            <div class="wz-field">
                                <label>{{ __('Bank Name') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="bank_name" class="wz-in" value="{{ old('bank_name') }}" x-model="fd.bank_name">
                            </div>
                            <div class="wz-field">
                                <label>{{ __('Account Number') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="bank_account_number" class="wz-in" value="{{ old('bank_account_number') }}" x-model="fd.bank_account_number">
                            </div>
                            <div class="wz-field">
                                <label>{{ __('Account Name') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="bank_account_name" class="wz-in" value="{{ old('bank_account_name') }}" x-model="fd.bank_account_name">
                            </div>
                            <div class="wz-field">
                                <label>{{ __('Branch Code') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="bank_branch_code" class="wz-in" value="{{ old('bank_branch_code') }}" x-model="fd.bank_branch_code">
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="fd.payment_method === 'mobile_money'" x-transition>
                        ...
                        <div class="wz-grid">
                            <div class="wz-field">
                                <label>{{ __('Provider') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="mobile_money_provider" class="wz-in" value="{{ old('mobile_money_provider') }}" x-model="fd.mobile_money_provider">
                            </div>
                            <div class="wz-field">
                                <label>{{ __('Mobile Number') }} <span class="wz-opt">{{ __('optional') }}</span></label>
                                <input type="text" name="mobile_money_number" class="wz-in" value="{{ old('mobile_money_number') }}" x-model="fd.mobile_money_number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wz-grid">
                        <div class="wz-field">
                            ...
                            <input type="text" name="payslip_password" class="wz-in" value="{{ old('payslip_password') }}" placeholder="{{ __('Auto-generated if blank') }}" x-model="fd.payslip_password">
            ...
            <div class="wzpanel" :class="{ 'wz-on': step === 6 }" x-show="step === 6" x-transition>
                ...
                <div class="wz-bd">
                    <div class="wz-review-grid">
                        {{-- Personal --}}
                        <div class="wz-rcard">
                            <div class="wz-rcard-h" @click="goToStep(1)">
                                <h2>{{ __('Personal Details') }}</h2>
                                <button type="button" class="wz-edit">{{ __('Edit') }}</button>
                            </div>
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    ...
                                    <div class="wz-fld"><div class="l">{{ __('Nationality') }}</div><div class="v" x-text="fd.nationality || '—'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Marital Status') }}</div><div class="v" x-text="fd.marital_status || '—'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Dependents') }}</div><div class="v" x-text="fd.dependents || '0'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Home Village') }}</div><div class="v" x-text="fd.home_village || '—'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Home District') }}</div><div class="v" x-text="fd.home_district || '—'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Next of Kin') }}</div><div class="v" x-text="fd.nok_name || '—'"></div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Employment --}}
                        <div class="wz-rcard">
                            <div class="wz-rcard-h" @click="goToStep(2)">
                                <h2>{{ __('Employment') }}</h2>
                                <button type="button" class="wz-edit">{{ __('Edit') }}</button>
                            </div>
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    ...
                                    <div class="wz-fld"><div class="l">{{ __('Branch') }}</div><div class="v" x-text="getSelectedText('branch_id') || '—'"></div></div>
                                    ...
                                    <div class="wz-fld" x-show="needsEndDate"><div class="l">{{ __('End Date') }}</div><div class="v" x-text="fd.employment_end_date || '—'"></div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Compensation --}}
                        <div class="wz-rcard">
                            <div class="wz-rcard-h" @click="goToStep(3)">
                            ...
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    ...
                                    <div class="wz-fld"><div class="l">{{ __('Housing') }}</div><div class="v" x-text="formatMoney(fd.housing_allowance)"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Transport') }}</div><div class="v" x-text="formatMoney(fd.transport_allowance)"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Other') }}</div><div class="v" x-text="formatMoney(fd.other_allowances)"></div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Deductions --}}
                        <div class="wz-rcard">
                            <div class="wz-rcard-h" @click="goToStep(4)">
                                <h2>{{ __('Deductions') }}</h2>
                                <button type="button" class="wz-edit">{{ __('Edit') }}</button>
                            </div>
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    ...
                                    <div class="wz-fld"><div class="l">{{ __('Pension Member No') }}</div><div class="v" x-text="fd.pension_member_number || '—'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Employee Contribution') }}</div><div class="v" x-text="(fd.pension_contribution || '0') + '%'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('Other Deductions') }}</div><div class="v" x-text="formatMoney(fd.other_deductions)"></div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Banking --}}
                        <div class="wz-rcard">
                            <div class="wz-rcard-h" @click="goToStep(5)">
                                <h2>{{ __('Banking') }}</h2>
                                <button type="button" class="wz-edit">{{ __('Edit') }}</button>
                            </div>
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    ...
                                    <div class="wz-fld" x-show="fd.payment_method === 'mobile_money'"><div class="l">{{ __('Provider') }}</div><div class="v" x-text="fd.mobile_money_provider || '—'"></div></div>
                                    <div class="wz-fld" x-show="fd.payment_method === 'mobile_money'"><div class="l">{{ __('Mobile No') }}</div><div class="v" x-text="fd.mobile_money_number || '—'"></div></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <template x-if="hasAnyBeneficiaryData">
                                    <div class="wz-g3">
                                        <template x-for="(ben, idx) in beneficiaries.filter(b => b.full_name || b.relationship || b.phone)" :key="idx">
                                            <div class="wz-fld">
                                                <div class="l" x-text="ben.full_name || '—'"></div>
                                                <div class="v" x-text="(ben.relationship || '—') + ' · ' + (ben.pct || 0) + '%'"></div>
                                            </div>
                                        </template>
                                    </div>
                                </template>
                                <template x-if="!hasAnyBeneficiaryData">
                                    <div style="color:var(--muted);font-size:13px;padding:8px 0">{{ __('No beneficiaries added.') }}</div>
                                </template>
                            </div>
                        </div>
                        ...
                        <div class="wz-rcard">
                            ...
                            <div class="wz-pad">
                                <div class="wz-g3">
                                    <div class="wz-fld"><div class="l">{{ __('Passport Photo') }}</div><div class="v" x-text="fd.photo_label || '{{ __('Not uploaded') }}'"></div></div>
                                    <div class="wz-fld"><div class="l">{{ __('National ID') }}</div><div class="v" x-text="fd.national_id_label || '{{ __('Not uploaded') }}'"></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Success box --}}
                    <div class="wz-success-box">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                        <div>
                            <strong>{{ __('Ready to submit') }}</strong>
                            <div style="font-size:12px;color:var(--muted);margin-top:2px">{{ __('This will create the employee record and send their login credentials.') }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- Action bar --}}
            <div class="wz-bar">
                <span class="wz-lbl">{{ __('Step') }} <span x-text="step"></span> {{ __('of') }} {{ $totalSteps }} &middot; <span x-text="Math.round((step / {{ $totalSteps }}) * 100)"></span>% {{ __('complete') }}</span>
                <div class="wz-bar-right">
                    ...
                    <button type="submit" class="wz-btn wz-btn-cta" x-show="step === {{ $totalSteps }}">{{ __('Submit & finish') }} &#10003;</button>
                </div>
            </div>
        </form>
        ...
        function payrollOnboard() {
            return {
                ...
                fd: {
                    ...
                    nationality: @js(old('nationality', 'Malawi')),
                    marital_status: @js(old('marital_status')),
                    dependents: @js(old('dependents')),
                    place_of_residence: @js(old('place_of_residence')),
                    home_village: @js(old('home_village')),
                    home_district: @js(old('home_district')),
                    nok_name: @js(old('nok_name')),
                    nok_relationship: @js(old('nok_relationship')),
                    nok_phone: @js(old('nok_phone')),
                    position: @js(old('position')),
                    department: @js(old('department')),
                    branch_id: @js(old('branch_id')),
                    employment_type: @js(old('employment_type', 'full_time')),
                    hire_date: @js(old('hire_date', date('Y-m-d'))),
                    employment_end_date: @js(old('employment_end_date')),
                    ...
                    payment_method: @js(old('payment_method', 'bank_transfer')),
                    ...
                    mobile_money_provider: @js(old('mobile_money_provider')),
                    mobile_money_number: @js(old('mobile_money_number')),
                ...
                beneficiaries: @js(collect(old('beneficiaries', [['full_name' => '', 'relationship' => '', 'phone' => '', 'pct' => '']]))->toArray()),
                ...
                addBeneficiary() {
                    this.beneficiaries.push({ full_name: '', relationship: '', phone: '', pct: '' });
                },
                ...
                previewFile(event, key) {
                    ...
                    if (!file) return;
                    const suffix = key === 'photo' ? '_label' : '_label';
                    this.fd[key + suffix] = file.name;
                },
                ...
                advanceStep() {
                    if (this.step < {{ $totalSteps }}) {
                        this.step++;
                        this.$nextTick(() => {
                            document.getElementById('onboard-form')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
                        });
                    }
                },
