<x-app-layout>
    <x-slot name="header">{{ __('Create Credit Note') }}</x-slot>

    <div class="pb-12">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 flex items-center justify-end">
                <x-button variant="primary" href="{{ route('accounting.credit-notes.create') }}">
                ...
                <form method="GET" action="{{ route('accounting.credit-notes.index') }}" class="flex items-end gap-4">
                    <div class="flex-1">
                        ...
                        <div class="scoped-search-field mt-1">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Customer name..." autocomplete="off" />
                            <span class="scoped-search-divider" aria-hidden="true"></span>
                            <button type="button" class="scoped-search-open" title="{{ __('Search this list') }}" onclick="window.dispatchEvent(new CustomEvent('open-global-search', { detail: { entity: 'credit-note' } }))">
                    ...
                    <table class="datasheet">
                        ...
                        <tbody>
                            @forelse($creditNotes as $creditNote)
                                <tr>
                                    <td>
                                        <a href="{{ route('accounting.credit-notes.show', $creditNote) }}" class="text-ink hover:text-gold">
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('accounting.credit-notes.show', $creditNote) }}" class="text-ink hover:text-gold">View</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
