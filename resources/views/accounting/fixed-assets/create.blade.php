                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-scoped-search-field
                                ...
                                :label="old('category_id') ? (($categories->firstWhere('id', (int) old('category_id')) ? $categories->firstWhere('id', (int) old('category_id'))->code . ' - ' . $categories->firstWhere('id', (int) old('category_id'))->name : '')) : ''"
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :value="old('branch_id')"
                                        :label="old('branch_id') ? (($branches ?? collect())->firstWhere('id', (int) old('branch_id'))?->name ?? '') : ''"
                                        placeholder="{{ __('None') }}"
                                    />
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :label="old('cost_center_id') ? (($costCenters ?? collect())->firstWhere('id', (int) old('cost_center_id'))?->name ?? '') : ''"
                                        placeholder="{{ __('None') }}"
                                    />
