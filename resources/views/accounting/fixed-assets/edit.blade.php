        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="form-page">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-scoped-search-field
                                        ...
                                        :value="old('vendor_id', $asset->vendor_id)"
                                        :label="old('vendor_name', $asset->vendor?->name ?? '')"
                ...
                <x-form.quick-actions :title="__('Quick Actions')" :groups="[
                    ['label' => __('View'), 'links' => [
                        ['title' => __('Asset Categories'), 'route' => route('accounting.asset-categories.index'), 'icon' => 'grid'],
                        ['title' => __('Fixed Assets List'), 'route' => route('accounting.fixed-assets.index'), 'icon' => 'bars3'],
                    ]],
                ]" />
            </div>
        </div>
