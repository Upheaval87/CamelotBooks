                ...
                <form method="POST" action="{{ route('accounting.fixed-assets.update', $asset) }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $asset->description) }}</textarea>
