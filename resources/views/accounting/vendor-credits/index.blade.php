<x-app-layout>
    ...
    <x-list-header title="{{ __('Create Vendor Credit') }}" />
                ...
                <form method="GET" action="{{ route('accounting.vendor-credits.index') }}" class="flex items-end gap-4">
                    <div class="flex-1">
                        ...
                        <div class="scoped-search-field mt-1">
                            ...
                            <button type="button" class="scoped-search-open" title="{{ __('Search this list') }}" onclick="window.dispatchEvent(new CustomEvent('open-global-search', { detail: { entity: 'vendor-credit' } }))">
