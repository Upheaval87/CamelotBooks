        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('accounting.vendor-credits.store') }}">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('Vendor Credit Details') }}</h3>
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="bill_id" name="bill_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
