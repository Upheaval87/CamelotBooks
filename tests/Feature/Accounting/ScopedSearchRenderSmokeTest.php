...
class ScopedSearchRenderSmokeTest extends TestCase
{
    ...
    public function test_converted_pages_render(): void
    {
        ...
        $reconInProgress = \App\Models\BankReconciliation::create([
            'company_id' => $this->company->id,
            'bank_account_id' => $bank->id,
            ...
            'status' => \App\Models\BankReconciliation::STATUS_IN_PROGRESS,
        ]);
        $reconCompleted = \App\Models\BankReconciliation::create([
            'company_id' => $this->company->id,
            'bank_account_id' => $bank->id,
        ...
        $routes = [
            ...
            'bank-reconciliation.import-form' => route('accounting.bank-reconciliation.import-form', $bank->id),
            'bank-reconciliation.show-in-progress' => route('accounting.bank-reconciliation.show', $reconInProgress->id),
            'bank-reconciliation.show-completed' => route('accounting.bank-reconciliation.show', $reconCompleted->id),
