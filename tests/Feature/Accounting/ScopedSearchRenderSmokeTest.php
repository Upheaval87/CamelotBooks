...
class ScopedSearchRenderSmokeTest extends TestCase
{
    ...
    public function test_converted_pages_render(): void
    {
        ...
        $routes = [
            ...
            'inventory.dashboard' => route('accounting.inventory.dashboard'),
            'inventory.items' => route('accounting.inventory.items'),
            ...
            'invsetup.landed' => route('accounting.invsetup.landed'),
